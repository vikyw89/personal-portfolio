...
export const Card = ({ props }: CardProps) => {
  ...
  const videoIsInView = useInView(video, { amount: 1 })
  ...
  return (
    <>
      <div ref={card} className="aspect w-full z-20 flex flex-col shadow-lg text-base-content sm:max-w-7xl sm:grid sm:grid-flow-dense sm:grid-cols-2 sm:gap-2 sm:backdrop-blur-sm sm:bg-secondary sm:text-secondary-content sm:bg-opacity-80 sm:rounded-xl">
        <div className="relative w-full">
          <video ref={video} preload="auto" className="aspect-square bg-primary bg-opacity-50 backdrop-blur-sm w-full shadow-2xl object-cover sm:aspect-square md:aspect-video" muted loop>
