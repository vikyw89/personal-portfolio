...
Command: npx gltfjsx@6.2.5 model6.glb -T
*/
...
export function Model(props:any) {
  const group = useRef()
  const loader = useGLTF('/model6-transformed.glb') as any
  const { nodes, materials, animations } = loader
...
useGLTF.preload('/model6-transformed.glb')
